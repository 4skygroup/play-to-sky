    ...
    <div className="flex gap-y-15 flex-col items-center w-125 py-10 px-12.5 border border-dark-gray border-solid rounded-sm">
      <div className="flex justify-between w-full">
        ...
        <div className="flex flex-col">
          ...
          <span className="font-bold text-xl bg-light-gray w-fit h-fit py-2.5 px-3.75">
            {cities.length}
          </span>
        </div>
      </div>
          ...
          <span
            ...
            className={
              index === cities.length - 1
                ? ""
                : "flex items-center gap-x-2 font-bold after:content-[''] after:w-1 after:h-1 after:bg-dark-gray after:rounded-full"
            }
          >
            {city}
          </span>
