...
function Home() {
  const subsidiariesClassName: string =
    "flex w-full justify-center bg-red p-28.75 h-fit text-white";
  const subsidiaries: SubsidiaryType[] = [
    ...
    },
    {
      ...
      className: subsidiariesClassName,
      additionnalClassName: "bg-pulse-x-agency-pink",
    },
    {
      ...
      className: subsidiariesClassName,
      additionnalClassName: "bg-snackly-orange",
    },
    {
      ...
      className: subsidiariesClassName,
      additionnalClassName: "bg-seofy-green",
    },
    {
    ...
    },
    {
      ...
      className: subsidiariesClassName,
      additionnalClassName: "bg-play-to-sky-productions-gray",
    },
    {
